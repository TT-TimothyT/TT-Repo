...
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('Data Sent','gravity-forms-netsuite-crm') ?></span></div>
...
<?php
      ...
      ?>
  <div class="vx_error"><i class="fa fa-warning"></i> <?php esc_html_e('Nothing Posted to Netsuite','gravity-forms-netsuite-crm');?></div>      
      <?php
  }
?>
</div></div>
    ...
    if(is_array($response) && count($response)>0){
      ...
      ?>
        <div class="crm_panel crm_panel_50">
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('Netsuite Response','gravity-forms-netsuite-crm') ?></span></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-netsuite-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('More Detail','gravity-forms-netsuite-crm') ?></span></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','gravity-forms-netsuite-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
?>
 ...
 if($error){
  ?>
<div class="vx_error"><i class="fa fa-warning"></i> <?php esc_html_e('Detail Not Found','gravity-forms-netsuite-crm');?></div>  
  <?php   
 } ?>
...
?>
<a href="<?php echo esc_url($feed_link) ?>" title="<?php esc_html_e('Edit Feed','gravity-forms-netsuite-crm') ?>" class="button"><i class="fa fa-edit"></i> <?php esc_html_e('Edit Feed','gravity-forms-netsuite-crm') ?></a>
<?php
    }
?>
<a href="<?php echo esc_url($log_link) ?>" title="<?php esc_html_e('Open in New Window','gravity-forms-netsuite-crm') ?>" target="_blank" class="button"><i class="fa fa-external-link"></i> <?php esc_html_e('Open in New Window','gravity-forms-netsuite-crm') ?></a>
<a href="#" class="button vx_close_detail" title="<?php esc_html_e('Close','gravity-forms-netsuite-crm') ?>"><i class="fa fa-times"></i> <?php esc_html_e('Close','gravity-forms-netsuite-crm') ?></a>
