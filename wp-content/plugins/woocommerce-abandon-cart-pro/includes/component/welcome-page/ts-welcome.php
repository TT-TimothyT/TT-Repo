    ...
    */
	...
	public function about_screen() {
		...
		if( isset( $license_status ) && $license_status != 'valid' && $accept == false && ! $display_failed ) {
			...
			// Check if we need to show the Import page.
			if ( 'no' === get_option( 'wcap_lite_data_imported', 'no' ) && array_key_exists( 'woocommerce-abandoned-cart/woocommerce-ac.php', get_plugins() ) ) {
