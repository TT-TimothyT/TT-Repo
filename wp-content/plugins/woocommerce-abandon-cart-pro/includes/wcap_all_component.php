	...
	class Wcap_All_Component {
		...
		public function __construct() {
			...
			if ( true === $is_admin ) {
				...
				$wcap_edd_license_expires   = 'edd_sample_license_expires';

                new wcap_active_license_notice ( $wcap_plugin_name, $wcap_edd_license_option, $wcap_license_path, $wcap_locale, $wcap_edd_license_expires );
        ...
        public static function wcap_get_faq () {
			...
			$ts_faq = array(
				...
				14 => array(
						...
						<br/><br/>
						You can <a href="https://support.tychesoftwares.com/help/2285384554/?utm_source=userwebsite&utm_medium=link&utm_campaign=AbandonedCartProFAQTab" target="_blank">contact</a> our support team to get this resolved as each custom button needs a different solution.' 
				),
				15 => array(
