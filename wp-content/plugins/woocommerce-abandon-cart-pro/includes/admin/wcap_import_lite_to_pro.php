...
if ( !class_exists('Wcap_Import_Lite_to_Pro' ) ) {
    ...
    class Wcap_Import_Lite_to_Pro {
        ...
        public static function wcap_get_import_data () {
            update_option( 'wcap_migrated_from_lite', true );
            $wcap_version = WCAP_PLUGIN_VERSION;
            ?>
            <div class="wrap about-wrap">
                <h2>
                    <?php printf(
                        /* translators: %1$s,%2$s are replaced with Plugin name and plugin version respectively */
                        __( 'Welcome to %1$s version %2$s', 'woocommerce-ac' ),
        ...
        public static function wcap_admin_init () {
            ...
            if (  ( $wcap_is_import_page_displayed != 'yes' || '' != $wcap_is_import_page_displayed ) && false === $wcap_is_import_page_displayed  ) {
                ...
                wp_safe_redirect( admin_url( 'admin.php?page=wcap-update&wcap_plugin_link=wcap-update' ) );
                exit;
            }
