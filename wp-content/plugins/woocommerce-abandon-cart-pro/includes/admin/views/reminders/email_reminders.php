...
?>
<template id="email_reminders">
<!-- Content Area -->
          <div class="container fas-page-wrap " id="email_reminders_cover" >
                  ...
                  <div class="col-md-12">
                     <div class="tm1-row bdr-0 pt-0 delvry-sch-bottom mb-4">
                        <div class="abulk-box pt-0 ">
                           <p class="mb-0"><?php esc_html_e( 'The Report below shows emails sent, emails opened and other related stats for the selected date range', 'woocommerce-ac' ); ?></p>
                        </div>
                     </div>
                     <div class="tm1-row bdr-0 pt-0 delvry-sch-bottom mb-4">
                        
                        <div class="action-url">
                           <button class="trietary-btn reverse" type="button"><?php esc_html_e( 'Email Sent', 'woocommerce-ac' ); ?>: {{settings.total_items}}</button>
                           <button class="trietary-btn reverse" type="button"><?php esc_html_e( 'Email Opened', 'woocommerce-ac' ); ?>: {{settings.open_emails}}</button>
                                 ...
                                 <div class="tm2-inner-wrap tbl-responsive">
                                    <table class="for-action" style="display: none;">
                                       <tbody>
                                          <tr>
                                             <td>
                                                <button type="button" class="btn btn-outline-primary blue-button btn-sm add-new"><?php esc_html_e( 'Save Setting', 'woocommerce-ac' ); ?></button>
                                                <a class="edit-delvry-sche edit" data-toggle="collapse" href="#" id="action-edit" role="button" aria-expanded="false" aria-controls="collapseExample" style="display: none;"> <?php esc_html_e( 'Edit', 'woocommerce-ac' ); ?></a>
                                    ...
                                    <table class="table">
                                       <thead>
                                          <tr>
                                             <th><?php esc_html_e( 'User Email Address', 'woocommerce-ac' ); ?></th>
                                             <th><?php esc_html_e( 'Email Sent Time', 'woocommerce-ac' ); ?></th>
                                             <th><?php esc_html_e( 'Date / Time Email Opened', 'woocommerce-ac' ); ?></th>
                                             <th><?php esc_html_e( 'Link Clicked', 'woocommerce-ac' ); ?></th>
                                             <th><?php esc_html_e( 'Sent Email Template', 'woocommerce-ac' ); ?></th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                         <tr class="cloned-row" v-for="( row, index ) in settings.email_reminders" :key="index">
											 
                                             <td>{{row.user_email_id}}
