    ...
    class Wcap_Localization{
        ...
        public static function wcap_register_template_string_for_wpml() {
            if ( function_exists('icl_register_string') ) {
                ...
                $result = $wpdb->get_results( "SELECT * FROM " . WCAP_NOTIFICATION_TEMPLATES_TABLE . " WHERE notification_type = 'email'" );
                ...
                // SMS & FB
                $short_messages = $wpdb->get_results( 'SELECT id, subject, body, type FROM ' . WCAP_NOTIFICATION_TEMPLATES_TABLE . " WHERE notification_type IN ('sms','fb')" );
