...
class Wcap_Hubspot_Get_Workflow extends Wcap_Call {

	public $call_slug = 'wcap_hubspot_get_workflow';
	...
	public function get_endpoint() {
		if ( isset( $this->data['workflow_id'] ) ) {
			return Wcap_Hubspot::get_endpoint( 'automation', 'v3' ) . 'workflows/' . $this->data['workflow_id'];
		}
...
return 'Wcap_Hubspot_Get_Workflow';
