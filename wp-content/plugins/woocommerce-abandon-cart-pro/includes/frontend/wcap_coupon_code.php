    ...
    class Wcap_Coupon{
        ...
        public static function wcap_capture_applied_coupon( $valid ) {
            ...
            if ( $valid != '' ) {
				...
				$applied = Wcap_Common::wcap_update_coupon_post_meta( $abandoned_cart_id, $coupon_code );
				if ( $applied ) {
					return $valid;
				}
        ...
        public static function wcap_capture_coupon_error( $valid, $new ) {
            ...
            if ( '' != $coupon_code ) {
                ...
                if ( $user_id > 0 ) {
					$updated = Wcap_Common::wcap_update_coupon_post_meta( $abandoned_cart_id, $coupon_code, $valid );
                }
                update_user_meta( $user_id, '_woocommerce_ac_coupon', $existing_coupon );
            }
            return $valid;
