    ...
    class WCAP_FB_Admin {
        ...
        function wcap_add_fb_settings() {
            ...
            add_settings_field(
                ...
                'woocommerce_ac_fb_page',
                'wcap_fb_settings_section',
                array( '<i>' . __( 'This option will display a checkbox after the Add to cart button for user consent to connect with Facebook.', 'woocommerce-ac' ) . '</i>', 'woocommerce-ac', 'wcap_enable_fb_reminders' ) 
            );
            ...
            add_settings_field(
                ...
                'woocommerce_ac_fb_page',
                'wcap_fb_settings_section',
                array( '<i>' . __( 'This option will display a checkbox on the pop-up modal to connect with Facebook.', 'woocommerce-ac' ) . '</i>', 'woocommerce-ac', 'wcap_enable_fb_reminders_popup' )
            );
            ...
            add_settings_field(
                ...
                'woocommerce_ac_fb_page',
                'wcap_fb_settings_section',
                array( '<i>' . __( 'Text that will appear above the consent checkbox. HTML tags are also allowed.', 'woocommerce-ac' ) . '</i>', 'woocommerce-ac', 'wcap_fb_consent_text' )
            );
            ...
            add_settings_field(
                ...
                'woocommerce_ac_fb_page',
                'wcap_fb_settings_section',
                array( '<i>'. __( 'Facebook Page ID in numberic format. You can find your page ID from <a href="https://www.tychesoftwares.com/docs/docs/abandoned-cart-pro-for-woocommerce/send-abandoned-cart-reminder-notifications-using-facebook-messenger#fbpageid" target="_blank">here</a>', 'woocommerce-ac' ) . '</i>' , 'woocommerce-ac', 'wcap_fb_page_id' )
            );
            ...
            add_settings_field(
                ...
                'woocommerce_ac_fb_page',
                'wcap_fb_settings_section',
                array( '<i>' . __( '<i>Enter your Messenger App ID</i>', 'woocommerce-ac' ) . '</i>', 'woocommerce-ac', 'wcap_fb_app_id' )
            );
            ...
            add_settings_field(
                ...
                'woocommerce_ac_fb_page',
                'wcap_fb_settings_section',
                array( '<i>' .__( 'Enter your Facebook Page Token</i>', 'woocommerce-ac') . '</i>', 'woocommerce-ac', 'wcap_fb_page_token' )
            );
            ...
            add_settings_field(
                ...
                'woocommerce_ac_fb_page',
                'wcap_fb_settings_section',
                array( '<i>' . __( 'Enter your Verify Token</i>', 'woocommerce-ac') . '</i>', 'woocommerce-ac', 'wcap_fb_verify_token' )
            );
