            ...
            vm = new Vue({
                ...
                methods: {
                    ...
                    wcap_load_data: function( template_id, db_data ){
                        ...
                        var a = $("button.wcap-toggle-template-status[wcap-fb-id='" + template_id + "']" );
                        ...
                        this.wcap_active_status = $(a).attr('wcap-template-switch') === 'on' ? 1 : 0;
                    ...
                    wcap_save_template: function(){
                        ...
                        jQuery.post( ajaxurl, data, config ).then( function( response ){
