...
/**
 * Kestrel Exchange Provider class.
 */
class Kestrel_Exchange_Provider extends Base_Exchange_Provider implements Exchange_Provider {
	 ...
	 * @var string
	 */
	protected $base_url = 'https://ccw-rates.kestrelwp.io/';
	...
	public function __construct() {
		$this->id          = 'kestrel_exchange';
		$this->name        = 'Kestrel Exchange Rates';
