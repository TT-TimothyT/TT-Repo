...
class Frontend extends Framework\SV_WC_Payment_Gateway_Apple_Pay_Frontend {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'wc-cybersource-apple-pay', $this->get_plugin()->get_plugin_url() . '/assets/js/frontend/wc-cybersource-apple-pay.min.js', [ 'jquery', 'sv-wc-apple-pay-v5_15_3' ], $this->get_plugin()->get_version() );
	}
