	...
	public function process_payment_page( $order_id) {
		...
		if ($config->is_complete()) {
			...
			<p class="loading-payment-text">
				...
				<?php
				$this->loading_icon = $this->get_option('loading_icon');
				$this->loading_icon = ( !empty($this->loading_icon) ) ? $this->loading_icon : apply_filters('loading_icon', plugins_url('assets/images/loading.gif', __FILE__));
				?>
				<img src="<?php echo esc_attr($this->loading_icon); ?>"/>
			</p>
