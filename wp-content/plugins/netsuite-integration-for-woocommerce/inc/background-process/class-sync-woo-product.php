...
class Sync_Woo_Product extends WP_Background_Process {


	protected $action = 'tm_ns_process_products';
	...
	protected function task( $data ) {
		...
		$order_netsuite_internal_id = $this->ProductClient->syncProductsOnWoo( $data['items'] );
