...
$opening_paragraph = __( 'A new order has been made by %s and the TPP Purchase failed in NetSuite. The details are as follows:', 'trek-travel-theme' );
...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	<tbody>
		<tr>
			<th scope="row" style="text-align:left; border: 1px solid #eee;"><?php _e( 'Booking ID', 'trek-travel-theme' ); ?></th>
			<td style="text-align:left; border: 1px solid #eee;"><?php echo $item_data->booking_id; ?></td>
		</tr>
		<tr>
			<th scope="row" style="text-align:left; border: 1px solid #eee;"><?php _e( 'Booking Order ID', 'trek-travel-theme' ); ?></th>
			<td style="text-align:left; border: 1px solid #eee;"><?php echo $item_data->booking_order_id; ?></td>
		</tr>
		<tr>
			<th scope="row" style="text-align:left; border: 1px solid #eee;"><?php _e( 'Product', 'trek-travel-theme' ); ?></th>
		...
		<tr>
			<th scope="row" style="text-align:left; border: 1px solid #eee;"><?php _e( 'Product ID', 'trek-travel-theme' ); ?></th>
...
<p><?php _e( 'This is a custom email sent when a TPP Purchase fails in NetSuite.', 'trek-travel-theme' ); ?></p>
