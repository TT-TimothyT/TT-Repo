...
echo sprintf( __( 'Booking ID: %s', 'trek-travel-theme' ), $item_data->booking_id ) . "\n";

echo sprintf( __( 'Booking Order ID: %s', 'trek-travel-theme' ), $item_data->booking_order_id ) . "\n";

echo sprintf( __( 'Product: %s', 'trek-travel-theme' ), $item_data->product_title ) . "\n";

echo sprintf( __( 'Quantity: %s', 'trek-travel-theme' ), $item_data->qty ) . "\n";

echo sprintf( __( 'SKU: %s', 'trek-travel-theme' ), $item_data->sku ) . "\n";

echo sprintf( __( 'Product ID: %s', 'trek-travel-theme' ), $item_data->product_id ) . "\n";
...
echo sprintf( __( 'NetSuite Errors: %s', 'trek-travel-theme' ), is_array( $item_data->ns_response->errors ) ? implode( ';', $item_data->ns_response->errors ) : $item_data->ns_response->errors ) . "\n";

echo sprintf( __( 'NetSuite Saved Data: %s', 'trek-travel-theme' ), json_encode( $item_data->ns_response->saved_data ) ) . "\n";

echo "\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n\n";

echo __( 'This is a custom email sent when a TPP Purchase fails in NetSuite.', 'trek-travel-theme' ) . "\n\n";
