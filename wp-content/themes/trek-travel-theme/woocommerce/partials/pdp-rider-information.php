...
<div class="container pdp-section" id="rider-information">
    <div class="row">
        <div class="col-12">
            ...
            <h5 class="fw-semibold pdp-section__title">Rider Information</h5>

            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-rider-tab" data-bs-toggle="tab" data-bs-target="#nav-rider" type="button" role="tab" aria-controls="nav-rider" aria-selected="true">Riders</button>
                    <button class="nav-link" id="nav-non-rider-tab" data-bs-toggle="tab" data-bs-target="#nav-non-rider" type="button" role="tab" aria-controls="nav-non-rider" aria-selected="false">Non-riders</button>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-rider" role="tabpanel" aria-labelledby="nav-rider-tab">
                    ...
                    <p class="rider-main-heading fw-bold">Rider Level: 3 - Active <i class="bi bi-info-circle pdp-rider-level"></i></p>
