        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <p class="fw-medium fs-xl lh-xl">Wait!</p>
                    <p class="fw-normal fs-md lh-md">Did you know this is a Level <span><?php echo $tripInfo['parent_rider_level']; ?></span> trip, which may not be recommended for the rider level you selected. We want to ensure this is the right trip for you. <a href="/activity-levels">Learn more</a> about rider levels or <a href="/contact-us">contact a trip consultant</a> for any questions!</p>
                </div>
