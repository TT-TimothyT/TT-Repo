        ...
        <div class="checkout-step-two-hotel__one-bed">
            ...
            <div class="checkout-step-two-hotel__room-quantity">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-number" <?php echo ($guest_left == 1) ? 'disabled="disabled"' : ''; ?> type="button" data-type="plus" data-field="single"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/room_counter_plus.svg" /></button>
                </div>
            </div>
        ...
        <div class="checkout-step-two-hotel__two-bed">
            ...
            <div class="checkout-step-two-hotel__room-quantity">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-number" <?php echo ($guest_left  == 1 ? 'disabled="disabled"' : ''); ?> type="button" data-type="plus" data-field="double"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/room_counter_plus.svg" /></button>
                </div>
            </div>
            <p class="fw-normal fs-sm lh-sm mb-4 text-muted checkout-step-two-hotel__room-occupancy">Double Occupancy <i class="bi bi-info-circle pdp-double-occupancy"></i></p>
        ...
        <div class="checkout-step-two-hotel__open-to-roommate">
            ...
            <div class="checkout-step-two-hotel__room-quantity">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-number" type="button" data-type="plus" data-field="roommate"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/room_counter_plus.svg" /></button>
                </div>
            </div>
            <p class="fw-normal fs-sm lh-sm mb-4 text-muted checkout-step-two-hotel__room-occupancy">Double Occupancy <i class="bi bi-info-circle pdp-double-occupancy"></i></p>
